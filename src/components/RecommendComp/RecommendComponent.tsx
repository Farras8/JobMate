        ...
        <div className="flex flex-wrap gap-2 mt-2">
            {skills.length > 0 ? skills.map(skill => (
                <span
                    ...
                    className={`text-xs font-semibold px-3 py-1.5 rounded-full transition-all duration-300 hover:scale-105 shadow-sm ${color === 'blue'
...
export const RecommendedJobCard: React.FC<RecommendedJobCardProps> = ({ job, isBookmarked, onToggleBookmark }) => {
    const getScoreColor = (score: number) => {
        // Skala warna disesuaikan untuk skor 0-1
        ...
        <div className="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:border-blue-200 flex flex-col justify-between transform hover:scale-105 hover:-translate-y-1">
            <div>
                ...
                {job.matchedSkills && job.matchedSkills.length > 0 ? (
                    <div className="mt-3">
                        <h4 className="text-xs font-bold text-gray-500 mb-2 uppercase">Keahlian Cocok</h4>
            ...
            <div className="mt-6 pt-4 border-t border-gray-100 flex items-center justify-between">
                <button
                    ...
                    className={`group/bookmark p-3 rounded-xl transition-all duration-300 transform hover:scale-110 ${isBookmarked
...
// --- List Component (Tidak ada perubahan) ---
