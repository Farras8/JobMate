        ...
        <div className="relative bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 p-4">
          ...
          <div className="relative flex justify-between items-center text-white">
            <div className="flex items-center">
              ...
              <div>
                <h2 className="text-lg font-bold mb-1">Edit Preferensi</h2>
                <p className="text-white/80 text-xs">Perbarui kriteria pekerjaan Anda</p>
              </div>
            </div>
            <button 
              onClick={onClose} 
        ...
        <div className="relative bg-gradient-to-r from-gray-50 to-white p-4 border-t border-gray-200/50">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center text-gray-500">
              ...
              <span className="text-xs">Pastikan data sudah benar</span>
            </div>
