...
import { Save, X, Calendar, Briefcase, Building, FileText, Sparkles, Clock } from 'lucide-react';
...
const EditExperienceForm: React.FC<EditExperienceFormProps> = ({ initialData, onClose, onUpdateSuccess }) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!formIsValid) {
      Swal.fire({
        ...
        customClass: {
          ...
          title: 'text-gray-800',
          confirmButton: 'rounded-xl px-6 py-3 font-semibold bg-gradient-to-r from-red-500 to-red-600'
        },
    ...
    if (!formData.id) {
      Swal.fire({
        title: 'Error',
        text: 'ID Pengalaman tidak ditemukan untuk pembaruan.',
        icon: 'error',
        customClass: {
          popup: 'rounded-2xl shadow-2xl',
          title: 'text-gray-800',
    ...
    try {
      ...
      Swal.fire({
        ...
        customClass: {
          popup: 'rounded-2xl shadow-2xl',
          title: 'text-gray-800',
          confirmButton: 'rounded-xl px-6 py-3 font-semibold bg-gradient-to-r from-green-500 to-green-600'
        },
        buttonsStyling: false
      });
      ...
      Swal.fire({
        title: 'Error',
        text: err.message || 'Gagal memperbarui pengalaman kerja.',
        icon: 'error',
        customClass: {
          popup: 'rounded-2xl shadow-2xl',
          title: 'text-gray-800',
          ...
          <div className="flex justify-between items-center mb-8 pb-6 border-b border-gray-200/50">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">Perbarui informasi pengalaman profesional Anda</p>
              </div>
            </div>
            <button 
              onClick={onClose} 
