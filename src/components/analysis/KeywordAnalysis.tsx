...
const usedKeywords = [
    'Pemasaran Digital', 'SEO', 'SEM', 'Google Ads', 'Bing Ads', 'Social Media Marketing',
    'Email Marketing', 'Content Marketing', 'Google Analytics', 'Google Tag Manager',
    'SEMrush', 'Manajemen Proyek', 'Komunikasi', 'Kerja Tim', 'Kemampuan Analitis'
];
const missingKeywords = ['Analisis Data', 'Manajemen Stakeholder', 'A/B testing', 'CRO'];
const suggestedKeywords = ['SQL', 'Tableau', 'JIRA', 'Power BI'];
                        ...
                        <div className="relative">
                            ...
                            <div className="flex flex-wrap gap-1 sm:gap-1.5 md:gap-2">
                                {usedKeywords.map((kw, idx) => (
                                    <span key={kw} className="inline-flex items-center gap-1 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-2 py-1 sm:px-2.5 sm:py-1 md:px-3 md:py-1.5 rounded-full text-xs sm:text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 max-w-full" style={{ animationDelay: `${idx * 0.1}s` }}>
                        ...
                        <div className="relative">
                            ...
                            <div className="flex flex-wrap gap-1 sm:gap-1.5 md:gap-2">
                                {missingKeywords.map((kw, idx) => (
                                    <span key={kw} className="inline-flex items-center gap-1 bg-gradient-to-r from-red-500 to-orange-500 text-white px-2 py-1 sm:px-2.5 sm:py-1 md:px-3 md:py-1.5 rounded-full text-xs sm:text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 max-w-full" style={{ animationDelay: `${idx * 0.1}s` }}>
                        ...
                        <div className="relative">
                            ...
                            <div className="flex flex-wrap gap-1 sm:gap-1.5 md:gap-2">
                                {suggestedKeywords.map((kw, idx) => (
                                    <span key={kw} className="inline-flex items-center gap-1 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-2 py-1 sm:px-2.5 sm:py-1 md:px-3 md:py-1.5 rounded-full text-xs sm:text-sm font-medium shadow-sm hover:shadow-md transition-all duration-200 hover:scale-105 max-w-full" style={{ animationDelay: `${idx * 0.1}s` }}>
